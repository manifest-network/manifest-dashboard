<script lang="ts">
  ...
  import type {PageProps} from "../../../.svelte-kit/types/src/routes/object_storage/$types";
...
<main class="p-4">
  <h2 class="text-xl font-bold mb-4">Object Storage</h2>
  {#await Promise.resolve(data.data) }
    <p>Loading object storage metrics data...</p>
  {:then datasets}
